...
Custom::Text::Unaccent::PurePerl - remove accents from characters

=head1 SYNOPSIS

  use Custom::Text::Unaccent::PurePerl qw(unac_string);
...
Modified to properly handle character 00DF.
...
package Custom::Text::Unaccent::PurePerl;
