package Custom::Text::ParseWords;
...
Custom::Text::ParseWords - parse text into an array of tokens or array of arrays. Modified to prevent single quotes (or apostrophes) from being treated as delimiters.
...
Modified to prevent single quotes (or apostrophes) from being treated
as delimiters.
...
Modified by Phil Lembo <eldapo@lembobrothers.com>.
